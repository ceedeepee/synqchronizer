...
console.log(chalk.gray('Note: This functionality is now integrated into synchronizer-cli v2.4.1+'));
console.log(chalk.gray('Use: synchronize test-websocket or access via web dashboard\n'));
